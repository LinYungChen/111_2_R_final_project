...
finalProject$board_analysis$ComparefemalePerformanceWithIndependentGoodAndOverall <- 
  bind_cols(finalProject$board_analysis$femalePerformaceWithIndependentGood,finalProject$board_analysis$femaleOverall)
